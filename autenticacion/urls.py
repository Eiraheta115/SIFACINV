...
urlpatterns = [
   ...
   # url(r'^restablecer-contraseña/$', authV.password_reset, {'post_reset_redirect': 'restablecer_contraseña_hecho'}, name='restablecer-contraseña'),
    #url(r'^restablecer-contraseña/hecho/$', authV.password_reset_done, name='restablecer_contraseña_hecho'),
    #url(r'^restablecer-contraseña/confirmar/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$', authV.password_reset_confirm, {'post_reset_redirect': 'restablecer_contraseña_completado'}, name='restablecer_contraseña_confirmar'),
    #url(r'^restablecer-contraseña/completado/$', authV.password_reset_complete, name='restablecer_contraseña_completado')
]